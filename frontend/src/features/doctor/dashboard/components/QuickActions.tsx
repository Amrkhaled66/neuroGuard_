...
const QuickActions = ({ onAdmitPatient }: QuickActionsProps) => {
    ...
    <div className="space-y-4 rounded-3xl app-surface  p-5 sm:p-6">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <button
          ...
          className="animate shadow-md hover:bg-brand-primary-softest/25 group flex min-h-24 cursor-pointer flex-col items-center justify-center space-y-2 rounded-2xl px-4 py-4 text-center drop-shadow-md transition-colors"
        >
